...
- `SHO-INTERNAL-CANDIDATE-001` ist ein interner WhatsApp-Fraud-Checklist Spin-off Candidate nach Brief-003-Option-C-Pivot und Brief-002-Claim-Boundaries; Final Article Candidate, drei interne Reviews und eine angewendete Content Quality Scorecard existieren, bleiben nicht publish-ready und bilden keinen offiziellen fuenften MVP-Brief.
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| SHO-INTERNAL-CANDIDATE-001 | WhatsApp-Fraud-Checklist | content_quality_scorecard_completed_not_publish_ready | not_assigned | internal_spinoff_candidate_not_official_batch_brief | prepare_targeted_revision_packet_internal_only | repo metadata for SHO-SRC-005, SHO-SRC-006 and SHO-SRC-007 is traceable; live_source_verification_status not_performed; source freshness not claimed; SHO-SRC-004 blocked UI context only | Final Article Candidate, Candidate Review, Source Metadata / Freshness Review, Accessibility / Senior Reader Review and Content Quality Scorecard exist; scorecard passed with P2/P3 findings and no P0/P1; real_user_testing_status not_performed; assistive_technology_testing_status not_performed; wcag_conformance_status not_tested | final_article_candidate_not_publish_ready | not_ready | not_accepted | not_ready | not_approved | SHO-CLAIM-007 blocked; targeted revision needed for link precision, jargon, internal markers and source/freshness gaps; no WhatsApp UI instructions or exact paths; no official MVP Brief 005 promotion |
...
- SHO_INTERNAL_CANDIDATE_001_TARGETED_REVISION_PACKET_INTERNAL_ONLY

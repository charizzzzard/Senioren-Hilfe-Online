...
- `SHO-INTERNAL-CANDIDATE-001` ist ein interner WhatsApp-Fraud-Checklist Spin-off Candidate nach Brief-003-Option-C-Pivot und Brief-002-Claim-Boundaries; er ist kein offizieller fuenfter MVP-Brief, kein Final Article Candidate und nicht publish-ready.
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| SHO-INTERNAL-CANDIDATE-001 | WhatsApp-Fraud-Checklist | final_article_candidate_preparation_decision_recorded_internal_only | not_assigned | internal_spinoff_candidate_not_official_batch_brief | prepare_final_article_candidate_internal_only | repo_sources_only_not_live_verified; SHO-SRC-005, SHO-SRC-006 and SHO-SRC-007 bounded; SHO-SRC-004 blocked UI context only | source inventory, brief candidate, brief review, draft candidate, draft review, revision candidate, revision review, gate review and Human Operator decision A exist internal-only | final_article_candidate_not_created | not_ready | not_accepted | not_ready | not_approved | SHO-CLAIM-007 blocked; no WhatsApp block/report UI instructions; no exact WhatsApp UI paths; no live source verification; no SEO metrics; no official MVP Brief 005 promotion |

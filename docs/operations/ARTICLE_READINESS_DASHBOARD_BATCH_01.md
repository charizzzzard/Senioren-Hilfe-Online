...
- `SHO-INTERNAL-CANDIDATE-001` ist ein interner WhatsApp-Fraud-Checklist Spin-off Candidate nach Brief-003-Option-C-Pivot und Brief-002-Claim-Boundaries. Auf Basis der Human-Operator-Option-A-Autorisierung wurden `SHO-SRC-005/006/007` kontrolliert live aufgerufen und interne Evidenz fuer `SHO-CLAIM-004/005/006` erfasst. Die Evidenz ist vorlaeufig; Freshness Review, Claim-Mapping Recheck und Final Source Metadata Review bleiben offen. Die unveraenderte Arbeitsgrundlage bleibt nicht publish-ready, nicht akzeptiert und kein offizieller fuenfter MVP-Brief.
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| SHO-INTERNAL-CANDIDATE-001 | WhatsApp-Fraud-Checklist | candidate_source_freshness_live_verification_evidence_recorded_internal_only | not_assigned | internal_spinoff_candidate_not_official_batch_brief | prepare_candidate_source_freshness_review_packet_internal_only | candidate-specific mapping unchanged: SHO-SRC-005/006 for SHO-CLAIM-004/005 and SHO-SRC-007 for SHO-CLAIM-006; authorized internal-only live evidence recorded; all three permitted sources accessible; source freshness remains preliminary_evidence_recorded_pending_review; final_publish_source_set_status not_approved; claim_recheck_status pending; SRC-GAP-WF-006 remains open; SHO-SRC-004 blocked UI context only | Internal evidence records exist for the authorized source/claim scope; SHO-SRC-005/006 have no visible date metadata and SHO-SRC-007 has a displayed Stand/date inconsistency requiring review; no final freshness or publication approval; real_user_testing_status not_performed; assistive_technology_testing_status not_performed; wcag_conformance_status not_tested; current working basis and historical candidate remain unchanged | final_article_candidate_not_publish_ready | not_ready | not_accepted | not_ready | not_approved | SHO-CLAIM-007 blocked; no Publish Gate, final freshness decision, final publication source set, WhatsApp UI validation, exact paths or official MVP Brief 005 promotion |

...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| SHO-INTERNAL-CANDIDATE-001 | WhatsApp-Fraud-Checklist | internal_final_article_candidate_option_a_review_completed_with_findings | not_assigned | internal_spinoff_candidate_not_official_batch_brief | prepare_human_operator_review_packet_for_internal_final_article_candidate_with_limitations_only | candidate-specific mapping unchanged: SHO-SRC-005/006 for SHO-CLAIM-004/005 and SHO-SRC-007 for SHO-CLAIM-006; all use remains limited and not finally approved; final_source_approval_status not_approved; final_claim_approval_status not_approved; final_citation_label_approval_status not_approved; SRC-GAP-WF-006 remains open for publish path; SHO-SRC-004 blocked UI context only | New internal Final Article Candidate Option A review completed with verdict pass_with_findings_not_publish_ready; candidate content unchanged; historical Final Article Candidate remains unchanged; no final article or publish candidate was created | historical_final_article_candidate_unchanged_not_publish_ready; new_final_article_candidate_status prepared_internal_only_with_limitations; final_article_candidate_option_a_review_status completed_internal_only_with_findings; publish_candidate_status not_created | not_ready | not_accepted | not_ready | not_approved | SHO-CLAIM-007 blocked; no final article creation, Publish Candidate, Publish Gate, final source/claim/citation approval, WhatsApp UI validation, exact paths or official MVP Brief 005 promotion |

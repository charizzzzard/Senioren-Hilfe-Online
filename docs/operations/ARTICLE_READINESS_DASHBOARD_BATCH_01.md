...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| SHO-INTERNAL-CANDIDATE-001 | WhatsApp-Fraud-Checklist | human_operator_review_packet_final_article_candidate_option_a_prepared_internal_only | not_assigned | internal_spinoff_candidate_not_official_batch_brief | await_human_operator_review_decision_for_internal_final_article_candidate_option_a | candidate-specific mapping unchanged: SHO-SRC-005/006 for SHO-CLAIM-004/005 and SHO-SRC-007 for SHO-CLAIM-006; all use remains limited and not finally approved; final_source_approval_status not_approved; final_claim_approval_status not_approved; final_citation_label_approval_status not_approved; SRC-GAP-WF-006 remains open for publish path; SHO-SRC-004 blocked UI context only | Human Operator Review Packet prepared internal-only; decision not recorded; selected option pending; Candidate Review verdict remains pass_with_findings_not_publish_ready; candidate content unchanged; historical Final Article Candidate unchanged; no final article or publish candidate created | historical_final_article_candidate_unchanged_not_publish_ready; new_final_article_candidate_status prepared_internal_only_with_limitations; human_operator_review_packet_status prepared_internal_only; human_operator_decision_status not_recorded; selected_option_status pending; publish_candidate_status not_created | not_ready | not_accepted | not_ready | not_approved | SHO-CLAIM-007 blocked; no final article creation, Publish Candidate, Publish Gate, final source/claim/citation approval, WhatsApp UI validation, exact paths or official MVP Brief 005 promotion |

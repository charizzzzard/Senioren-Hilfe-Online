...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| SHO-INTERNAL-CANDIDATE-001 | WhatsApp-Fraud-Checklist | candidate_source_and_claim_final_review_completed_internal_only_with_findings | not_assigned | internal_spinoff_candidate_not_official_batch_brief | prepare_human_operator_source_claim_review_packet_internal_only | candidate-specific mapping unchanged: SHO-SRC-005/006 for SHO-CLAIM-004/005 and SHO-SRC-007 for SHO-CLAIM-006; source_and_claim_final_review_status completed_internal_only_with_findings; human_operator_review_readiness ready_for_human_operator_source_claim_review_with_limitations; final_source_approval_status not_approved; final_claim_approval_status not_approved; final_citation_label_approval_status not_approved; SRC-GAP-WF-006 remains open; SHO-SRC-004 blocked UI context only | Consolidated review completed with P2/P3 findings: evidence, freshness, mapping and metadata reviews are organized for a later Human Operator review only; SHO-SRC-005/006 lack visible publication/update dates; SHO-SRC-007 has an unresolved Stand/entry-date inconsistency and remains general phishing context; no final freshness, source, claim, label or publication approval; real_user_testing_status not_performed; assistive_technology_testing_status not_performed; wcag_conformance_status not_tested; current working basis and historical candidate remain unchanged | final_article_candidate_not_publish_ready | not_ready | not_accepted | not_ready | not_approved | SHO-CLAIM-007 blocked; no Publish Gate, final freshness decision, final source approval, final claim approval, final citation label approval, WhatsApp UI validation, exact paths or official MVP Brief 005 promotion |

...
- `SHO-INTERNAL-CANDIDATE-001` ist ein interner WhatsApp-Fraud-Checklist Spin-off Candidate nach Brief-003-Option-C-Pivot und Brief-002-Claim-Boundaries. Der Candidate Claim Mapping Recheck ist intern mit Findings abgeschlossen: `SHO-CLAIM-004/005/006` koennen unter den dokumentierten Scope- und Datumsgrenzen in ein Final Source Metadata Review uebergehen. Finale Freshness, finale Source-/Claim-Freigaben und Publish Readiness bleiben offen. Die unveraenderte Arbeitsgrundlage bleibt nicht publish-ready, nicht akzeptiert und kein offizieller fuenfter MVP-Brief.
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| SHO-INTERNAL-CANDIDATE-001 | WhatsApp-Fraud-Checklist | candidate_claim_mapping_recheck_completed_internal_only_with_findings | not_assigned | internal_spinoff_candidate_not_official_batch_brief | prepare_candidate_final_source_metadata_review_packet_internal_only | candidate-specific mapping unchanged: SHO-SRC-005/006 for SHO-CLAIM-004/005 and SHO-SRC-007 for SHO-CLAIM-006; live evidence and source freshness reviewed internal-only; claim_recheck_status completed_internal_only_with_findings; final_source_approval_status not_approved; final_claim_approval_status not_approved; SRC-GAP-WF-006 remains open; SHO-SRC-004 blocked UI context only | Claim Mapping Recheck completed with P2/P3 findings: SHO-CLAIM-004/005 remain limited to the observed police-source support; SHO-CLAIM-006 remains general phishing context only; missing or inconsistent date metadata must be handled in the Final Source Metadata Review; no final freshness, source, claim or publication approval; real_user_testing_status not_performed; assistive_technology_testing_status not_performed; wcag_conformance_status not_tested; current working basis and historical candidate remain unchanged | final_article_candidate_not_publish_ready | not_ready | not_accepted | not_ready | not_approved | SHO-CLAIM-007 blocked; no Publish Gate, final freshness decision, final source metadata approval, final claim approval, final publication source set, WhatsApp UI validation, exact paths or official MVP Brief 005 promotion |

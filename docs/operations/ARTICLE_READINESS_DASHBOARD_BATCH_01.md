...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| SHO-INTERNAL-CANDIDATE-001 | WhatsApp-Fraud-Checklist | limited_internal_post_boundary_task_packet_prepared_internal_only | not_assigned | internal_spinoff_candidate_not_official_batch_brief | review_limited_internal_post_boundary_task_packet_with_limitations_only | candidate-specific mapping unchanged: SHO-SRC-005/006 for SHO-CLAIM-004/005 and SHO-SRC-007 for SHO-CLAIM-006; all use remains limited and not finally approved; final_source_approval_status not_approved; final_claim_approval_status not_approved; final_citation_label_approval_status not_approved; SRC-GAP-WF-006 remains open for publish path; SHO-SRC-004 blocked UI context only | Limited Internal Post-Boundary Task Selection Preparation Packet prepared internal-only; decision_status not_recorded; selected_next_path_status not_selected; task_selection_status prepared_not_selected; recommended_task_option_status non_binding_not_selected; no task selected for execution; Option A remains non-binding recommendation only. Limited Internal Post-Boundary Task Packet prepared internal-only; task_execution_status not_performed; prepared_limited_task limited_internal_post_boundary_traceability_and_gap_consolidation_task; prepared_limited_task_execution_status not_performed; latest basis review_verdict pass_for_next_internal_step_preparation_with_findings_not_publish_ready; p0_findings none; p1_findings none; next_internal_gate candidate_citation_label_carry_forward_boundary_gate_internal_only; citation_label_carry_forward_status candidate_only_not_finally_approved; citation labels remain candidate_not_approved; no metadata inference, browsing or live verification; no source/claim/freshness/citation approval; candidate content unchanged; historical Final Article Candidate unchanged; no final article or publish candidate created | historical_final_article_candidate_unchanged_not_publish_ready; new_final_article_candidate_status prepared_internal_only_with_limitations; boundary_review_status completed_internal_only_with_findings; boundary_review_verdict requires_metadata_follow_up_before_publish_path; source_metadata_and_citation_follow_up_human_operator_decision_status recorded; source_metadata_citation_follow_up_execution_record_status performed_internal_only_limited; source_metadata_citation_follow_up_execution_record_review_status completed_internal_only; source_metadata_citation_label_review_packet_status prepared_internal_only; source_metadata_citation_label_review_record_status completed_internal_only; source_metadata_citation_label_review_record_verdict pass_for_human_operator_citation_label_decision_preparation_with_findings_not_publish_ready; human_operator_citation_label_review_decision_status recorded; human_operator_citation_label_review_selected_option option_a; citation_label_internal_next_gate_authorization_status authorized_internal_only_with_limitations; citation_label_option_a_next_internal_gate_packet_status prepared_internal_only; citation_label_option_a_next_internal_gate_review_status completed_internal_only; citation_label_option_a_next_internal_gate_review_verdict pass_for_next_internal_step_preparation_with_findings_not_publish_ready; citation_label_option_a_next_internal_gate_review_p0_findings none; citation_label_option_a_next_internal_gate_review_p1_findings none; post_citation_label_carry_forward_boundary_decision_or_task_packet_status prepared_internal_only; post_citation_label_carry_forward_boundary_decision_status not_recorded; post_citation_label_carry_forward_boundary_selected_next_path_status not_selected; limited_internal_post_boundary_task_selection_preparation_status prepared_internal_only; limited_internal_post_boundary_task_selection_decision_status not_recorded; limited_internal_post_boundary_task_selection_selected_next_path_status not_selected; limited_internal_post_boundary_task_selection_status prepared_not_selected; limited_internal_post_boundary_task_packet_status prepared_internal_only; limited_internal_post_boundary_task_packet_execution_status not_performed; limited_internal_post_boundary_prepared_limited_task limited_internal_post_boundary_traceability_and_gap_consolidation_task; limited_internal_post_boundary_prepared_limited_task_execution_status not_performed; superseded_artifact_level limited_internal_post_boundary_task_selection_preparation_prepared_internal_only; superseded_allowed_next_action await_human_operator_or_prepare_limited_internal_post_boundary_task_packet_with_limitations_only; citation_label_review_status completed_internal_only; citation_approval_status not_approved; source_approval_status not_approved; claim_approval_status not_approved; freshness_approval_status not_approved; publish_candidate_status not_created | not_ready | not_accepted | not_ready | not_approved | SHO-CLAIM-007 and SHO-SRC-004 blocked; no final source/claim/citation/freshness approval, Publish Candidate, UI validation, exact paths or official MVP Brief 005 promotion |
...
- post_citation_label_carry_forward_boundary_allowed_next_step: await_or_prepare_limited_internal_post_boundary_task_selection_with_limitations_only
...
- limited_internal_post_boundary_task_selection_allowed_next_step: await_human_operator_or_prepare_limited_internal_post_boundary_task_packet_with_limitations_only
...
- limited_internal_post_boundary_task_packet_allowed_next_step: review_limited_internal_post_boundary_task_packet_with_limitations_only

Legacy validator anchors retained as superseded historical state:

- superseded_human_operator_citation_label_review_decision_option_a_artifact_level: human_operator_citation_label_review_decision_option_a_recorded_internal_only
- superseded_human_operator_citation_label_review_decision_option_a_allowed_next_step: prepare_next_internal_gate_after_citation_label_option_a_with_limitations_only
- superseded_citation_label_option_a_next_internal_gate_packet_artifact_level: citation_label_option_a_next_internal_gate_packet_prepared_internal_only
- superseded_citation_label_option_a_next_internal_gate_packet_allowed_next_step: review_next_internal_gate_after_citation_label_option_a_with_limitations_only
- superseded_citation_label_option_a_next_internal_gate_review_artifact_level: citation_label_option_a_next_internal_gate_review_completed_internal_only
- superseded_citation_label_option_a_next_internal_gate_review_allowed_next_step: prepare_post_citation_label_carry_forward_boundary_decision_or_task_packet_internal_only
...
- superseded_limited_internal_post_boundary_task_selection_artifact_level: limited_internal_post_boundary_task_selection_preparation_prepared_internal_only
- superseded_limited_internal_post_boundary_task_selection_allowed_next_step: await_human_operator_or_prepare_limited_internal_post_boundary_task_packet_with_limitations_only
- superseded_post_citation_label_carry_forward_boundary_artifact_level: post_citation_label_carry_forward_boundary_decision_or_task_packet_prepared_internal_only

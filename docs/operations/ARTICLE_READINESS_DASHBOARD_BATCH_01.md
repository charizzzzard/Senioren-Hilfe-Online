...
- Brief 002 ist final_article_preparation_allowed_not_publish_ready, aber nicht publish-ready.
...
- current_artifact_level: final_article_preparation_allowed_not_publish_ready
- allowed_next_step: final article candidate preparation
...
- review_state: draft candidate exists; re-review passed not publish-ready; final source list review exists; final legal wording review exists; operator decision allows final article preparation only
- publish_readiness: not_ready
- operator_acceptance: not_accepted

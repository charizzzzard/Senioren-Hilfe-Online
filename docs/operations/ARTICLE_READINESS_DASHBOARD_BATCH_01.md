...
- `SHO-INTERNAL-CANDIDATE-001` ist ein interner WhatsApp-Fraud-Checklist Spin-off Candidate nach Brief-003-Option-C-Pivot und Brief-002-Claim-Boundaries. Das Candidate Source Freshness Review ist intern mit Findings abgeschlossen: `SHO-SRC-005/006/007` koennen mit dokumentierten Datums- und Scope-Einschraenkungen in einen Claim-Mapping-Recheck uebergehen. Finale Freshness, finales Metadatenreview und finale Source-Freigabe bleiben offen. Die unveraenderte Arbeitsgrundlage bleibt nicht publish-ready, nicht akzeptiert und kein offizieller fuenfter MVP-Brief.
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| SHO-INTERNAL-CANDIDATE-001 | WhatsApp-Fraud-Checklist | candidate_source_freshness_review_completed_internal_only_with_findings | not_assigned | internal_spinoff_candidate_not_official_batch_brief | prepare_candidate_claim_mapping_recheck_packet_internal_only | candidate-specific mapping unchanged: SHO-SRC-005/006 for SHO-CLAIM-004/005 and SHO-SRC-007 for SHO-CLAIM-006; live evidence reviewed internal-only; source freshness reviewed with limitations and not finally verified; final_publish_source_set_status not_approved; claim_recheck_status pending; SRC-GAP-WF-006 remains open; SHO-SRC-004 blocked UI context only | Freshness review completed with P2/P3 findings: SHO-SRC-005/006 lack visible date metadata; SHO-SRC-007 has a Stand/date inconsistency and remains general phishing context; all three may advance only to an internal Claim Mapping Recheck; no final freshness or publication approval; real_user_testing_status not_performed; assistive_technology_testing_status not_performed; wcag_conformance_status not_tested; current working basis and historical candidate remain unchanged | final_article_candidate_not_publish_ready | not_ready | not_accepted | not_ready | not_approved | SHO-CLAIM-007 blocked; no Publish Gate, final freshness decision, final source metadata approval, final publication source set, WhatsApp UI validation, exact paths or official MVP Brief 005 promotion |

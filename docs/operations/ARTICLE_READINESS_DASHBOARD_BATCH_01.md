...
- `SHO-INTERNAL-CANDIDATE-001` ist ein interner WhatsApp-Fraud-Checklist Spin-off Candidate nach Brief-003-Option-C-Pivot und Brief-002-Claim-Boundaries. Die Human-Operator-Entscheidung Option A fuer eine moegliche neue Final-Article-Candidate-Erstellung ist internal-only aufgezeichnet; sie autorisiert nur eine spaetere interne Candidate-Vorbereitung mit allen Limitierungen. Kein neuer Final Article Candidate, finaler Artikel oder Publish Candidate wurde erstellt. Fehlende Datumsmetadaten bei `SHO-SRC-005/006`, die Datums-/Kontextgrenze bei `SHO-SRC-007`, `SRC-GAP-WF-006`, `SHO-SRC-004` und `SHO-CLAIM-007` bleiben offen oder blockiert. Finaler Artikel, Publish Candidate, finale Freshness, Citation Labels, Source-/Claim-Freigaben, Publish Readiness und Operator Acceptance bleiben negativ.
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| SHO-INTERNAL-CANDIDATE-001 | WhatsApp-Fraud-Checklist | human_operator_final_article_candidate_creation_decision_option_a_recorded_internal_only | not_assigned | internal_spinoff_candidate_not_official_batch_brief | prepare_internal_final_article_candidate_with_limitations_only | candidate-specific mapping unchanged: SHO-SRC-005/006 for SHO-CLAIM-004/005 and SHO-SRC-007 for SHO-CLAIM-006; all use remains limited and not finally approved; final_source_approval_status not_approved; final_claim_approval_status not_approved; final_citation_label_approval_status not_approved; SRC-GAP-WF-006 remains open for publish path; SHO-SRC-004 blocked UI context only | Option A is recorded; later internal Final Article Candidate preparation is authorized with limitations only; no new Final Article Candidate, final article or publish candidate was created; SHO-SRC-005/006 lack visible publication/update dates; SHO-SRC-007 has date/context and general-phishing limitations; current working basis and historical candidate remain unchanged | historical_final_article_candidate_unchanged_not_publish_ready; new_final_article_candidate_status not_created | not_ready | not_accepted | not_ready | not_approved | SHO-CLAIM-007 blocked; no final article creation, Publish Candidate, Publish Gate, final source/claim/citation approval, WhatsApp UI validation, exact paths or official MVP Brief 005 promotion |

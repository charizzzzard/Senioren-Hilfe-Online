...
- `SHO-INTERNAL-CANDIDATE-001` ist ein interner WhatsApp-Fraud-Checklist Spin-off Candidate nach Brief-003-Option-C-Pivot und Brief-002-Claim-Boundaries. Die Candidate Source Freshness Live Verification Checklist definiert nur spaetere Prueffelder und ein leeres Evidence-Schema. Es gab kein Browsing, keine Live-Verifikation und keine Freshness-Behauptung. Die unveraenderte Arbeitsgrundlage bleibt nicht publish-ready, nicht akzeptiert und kein offizieller fuenfter MVP-Brief.

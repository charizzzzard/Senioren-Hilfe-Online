...
- `SHO-INTERNAL-CANDIDATE-001` ist ein interner WhatsApp-Fraud-Checklist Spin-off Candidate nach Brief-003-Option-C-Pivot und Brief-002-Claim-Boundaries. Das Candidate Final Source Metadata Review ist intern mit Findings abgeschlossen: Titel, Publisher, URLs und Zugriffsdaten sind nachvollziehbar; fehlende Datumsmetadaten bei `SHO-SRC-005/006` und die Datumsinkonsistenz bei `SHO-SRC-007` bleiben dokumentierte Grenzen. Nur ein internes Source-and-Claim-Final-Review ist als naechster Schritt erlaubt. Finale Freshness, Citation Labels, Source-/Claim-Freigaben und Publish Readiness bleiben offen.
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| SHO-INTERNAL-CANDIDATE-001 | WhatsApp-Fraud-Checklist | candidate_final_source_metadata_review_completed_internal_only_with_findings | not_assigned | internal_spinoff_candidate_not_official_batch_brief | prepare_candidate_source_and_claim_final_review_packet_internal_only | candidate-specific mapping unchanged: SHO-SRC-005/006 for SHO-CLAIM-004/005 and SHO-SRC-007 for SHO-CLAIM-006; final_source_metadata_review_status completed_internal_only_with_findings; final_source_approval_status not_approved; final_claim_approval_status not_approved; final_publication_citation_labels_status not_approved; SRC-GAP-WF-006 remains open; SHO-SRC-004 blocked UI context only | Metadata Review completed with P2/P3 findings: URLs, titles, publishers and access dates are traceable; SHO-SRC-005/006 lack visible publication/update dates; SHO-SRC-007 has an unresolved Stand/entry-date inconsistency and remains general phishing context; proposed citation labels are internal review aids only; no final freshness, source, claim, label or publication approval; real_user_testing_status not_performed; assistive_technology_testing_status not_performed; wcag_conformance_status not_tested; current working basis and historical candidate remain unchanged | final_article_candidate_not_publish_ready | not_ready | not_accepted | not_ready | not_approved | SHO-CLAIM-007 blocked; no Publish Gate, final freshness decision, final source approval, final claim approval, final publication citation label, WhatsApp UI validation, exact paths or official MVP Brief 005 promotion |

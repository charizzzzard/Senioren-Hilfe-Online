...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| SHO-INTERNAL-CANDIDATE-001 | WhatsApp-Fraud-Checklist | human_operator_citation_label_review_decision_option_a_recorded_internal_only | not_assigned | internal_spinoff_candidate_not_official_batch_brief | prepare_next_internal_gate_after_citation_label_option_a_with_limitations_only | candidate-specific mapping unchanged: SHO-SRC-005/006 for SHO-CLAIM-004/005 and SHO-SRC-007 for SHO-CLAIM-006; all use remains limited and not finally approved; final_source_approval_status not_approved; final_claim_approval_status not_approved; final_citation_label_approval_status not_approved; SRC-GAP-WF-006 remains open for publish path; SHO-SRC-004 blocked UI context only | Human Operator Citation Label Review Decision Option A recorded internal-only from Decision Preparation Packet; selected_option option_a; internal_next_gate_authorization_status authorized_internal_only_with_limitations; citation labels remain candidate_not_approved; no metadata resolved, no browsing or live verification, no source/claim/freshness/citation approval; candidate content unchanged; historical Final Article Candidate unchanged; no final article or publish candidate created | historical_final_article_candidate_unchanged_not_publish_ready; new_final_article_candidate_status prepared_internal_only_with_limitations; boundary_review_status completed_internal_only_with_findings; boundary_review_verdict requires_metadata_follow_up_before_publish_path; source_metadata_and_citation_follow_up_human_operator_decision_status recorded; source_metadata_citation_follow_up_execution_record_status performed_internal_only_limited; source_metadata_citation_follow_up_execution_record_review_status completed_internal_only; source_metadata_citation_label_review_packet_status prepared_internal_only; source_metadata_citation_label_review_record_status completed_internal_only; source_metadata_citation_label_review_record_verdict pass_for_human_operator_citation_label_decision_preparation_with_findings_not_publish_ready; human_operator_citation_label_review_decision_preparation_status prepared_internal_only; human_operator_citation_label_review_decision_status recorded; human_operator_citation_label_review_selected_option option_a; citation_label_internal_next_gate_authorization_status authorized_internal_only_with_limitations; citation_label_review_status completed_internal_only; citation_approval_status not_approved; source_approval_status not_approved; claim_approval_status not_approved; freshness_approval_status not_approved; publish_candidate_status not_created | not_ready | not_accepted | not_ready | not_approved | SHO-CLAIM-007 and SHO-SRC-004 blocked; no final source/claim/citation/freshness approval, Publish Candidate, UI validation, exact paths or official MVP Brief 005 promotion |
...
- superseded_source_metadata_citation_label_review_record_artifact_level: source_metadata_citation_label_review_record_completed_internal_only
- superseded_source_metadata_citation_label_review_record_allowed_next_step: prepare_human_operator_decision_for_citation_label_review_internal_only
- superseded_source_metadata_citation_label_review_packet_artifact_level: source_metadata_citation_label_review_packet_prepared_internal_only
- superseded_source_metadata_citation_label_review_packet_allowed_next_step: review_internal_citation_label_review_packet_with_limitations_only
- superseded_source_metadata_citation_label_review_packet_status_note: citation_label_review_status prepared_not_performed
- superseded_source_metadata_and_citation_follow_up_selected_option: source_metadata_and_citation_follow_up_selected_option option_a
- superseded_source_metadata_citation_follow_up_task_preparation_status: source_metadata_citation_follow_up_task_preparation_status prepared_internal_only
- superseded_source_metadata_citation_follow_up_execution_record_citation_status: citation_follow_up_status candidate_labels_recorded_not_approved
- superseded_source_metadata_citation_follow_up_execution_record_review_verdict: pass_for_next_internal_citation_label_review_with_findings_not_publish_ready
- superseded_source_metadata_citation_follow_up_execution_record_review_artifact_level: source_metadata_citation_follow_up_execution_record_review_completed_internal_only
- superseded_source_metadata_citation_follow_up_execution_record_review_allowed_next_step: prepare_internal_citation_label_review_packet_with_limitations_only
- superseded_source_metadata_citation_follow_up_execution_record_artifact_level: source_metadata_citation_follow_up_execution_record_performed_internal_only_limited
- superseded_source_metadata_citation_follow_up_execution_record_allowed_next_step: review_limited_source_metadata_citation_follow_up_record_internal_only
- superseded_source_metadata_citation_follow_up_execution_record_metadata_status_note: metadata_resolution_status performed_internal_only_limited
- superseded_source_metadata_citation_follow_up_task_preparation_artifact_level: source_metadata_citation_follow_up_task_preparation_prepared_internal_only
- superseded_source_metadata_citation_follow_up_task_preparation_artifact_level_anchor: current_artifact_level: source_metadata_citation_follow_up_task_preparation_prepared_internal_only
- superseded_source_metadata_citation_follow_up_task_preparation_allowed_next_step: perform_limited_internal_source_metadata_citation_follow_up_with_limitations_only
- superseded_source_metadata_citation_follow_up_task_preparation_execution_status_note: follow_up_execution_status not_performed
- superseded_source_metadata_citation_follow_up_task_preparation_metadata_status_note: metadata_resolution_status not_performed
- superseded_source_metadata_citation_follow_up_packet_status_note: source_metadata_and_citation_follow_up_packet_status prepared_internal_only
- superseded_source_metadata_follow_up_status_note: source_metadata_follow_up_status prepared_not_performed
- superseded_citation_follow_up_status_note: citation_follow_up_status prepared_not_performed
- superseded_source_metadata_citation_follow_up_decision_preparation_artifact_level: source_metadata_citation_follow_up_decision_preparation_prepared_internal_only
- superseded_source_metadata_citation_follow_up_decision_preparation_allowed_next_step: await_human_operator_decision_on_source_metadata_and_citation_follow_up_internal_only
- superseded_source_metadata_citation_follow_up_packet_artifact_level: source_metadata_citation_follow_up_packet_prepared_internal_only
- superseded_source_metadata_citation_follow_up_packet_allowed_next_step: prepare_human_operator_decision_for_source_metadata_and_citation_follow_up_internal_only
- superseded_source_metadata_citation_follow_up_option_a_decision_artifact_level: source_metadata_citation_follow_up_decision_option_a_recorded_internal_only
- superseded_source_metadata_citation_follow_up_option_a_decision_allowed_next_step: prepare_internal_source_metadata_citation_follow_up_task_with_limitations_only
- superseded_source_claim_citation_boundary_review_artifact_level: source_claim_citation_boundary_review_completed_internal_only_with_findings
- superseded_source_claim_citation_boundary_review_allowed_next_step: prepare_source_metadata_and_citation_follow_up_packet_internal_only
- superseded_source_claim_citation_boundary_review_verdict: requires_metadata_follow_up_before_publish_path
- superseded_next_internal_gate_packet_artifact_level: final_article_candidate_option_a_next_internal_gate_packet_prepared_internal_only
- superseded_next_internal_gate_packet_allowed_next_step: prepare_candidate_source_claim_citation_boundary_review_internal_only
- superseded_next_internal_gate_definition: candidate_source_claim_citation_boundary_gate_internal_only
- superseded_internal_next_gate_authorization_status: internal_next_gate_authorization_status authorized_internal_only_with_limitations
- superseded_candidate_review_verdict: pass_with_findings_not_publish_ready
- current_blocked_claim_status: SHO-CLAIM-007 blocked
- superseded_human_operator_review_decision_artifact_level: human_operator_review_decision_final_article_candidate_option_a_recorded_internal_only
- superseded_human_operator_review_decision_allowed_next_step: prepare_next_internal_candidate_gate_packet_with_limitations_only
- superseded_human_operator_review_packet_status: human_operator_review_packet_status prepared_internal_only
...
- superseded_human_operator_review_packet_artifact_level: human_operator_review_packet_final_article_candidate_option_a_prepared_internal_only
- superseded_human_operator_review_packet_allowed_next_step: await_human_operator_review_decision_for_internal_final_article_candidate_option_a
- superseded_human_operator_review_packet_decision_note: human_operator_decision_status not_recorded; selected_option_status pending
...
- superseded_human_operator_source_claim_review_packet_artifact_level: human_operator_source_claim_review_packet_prepared_internal_only
- superseded_human_operator_source_claim_review_packet_allowed_next_step: record_human_operator_source_claim_review_decision_internal_only
- superseded_human_operator_source_claim_review_packet_decision_note: human_operator_decision_status not_recorded
- superseded_human_operator_source_claim_review_readiness: ready_for_human_operator_source_claim_review_with_limitations
- superseded_source_claim_decision_artifact_level: human_operator_source_claim_review_decision_option_a_recorded_internal_only
- superseded_source_claim_decision_allowed_next_step: prepare_candidate_final_article_preparation_gate_review_internal_only
- superseded_source_claim_package_decision_status: accepted_for_next_internal_gate_with_limitations
- superseded_final_article_preparation_gate_review_artifact_level: candidate_final_article_preparation_gate_review_post_source_claim_decision_completed_internal_only_with_findings
- superseded_final_article_preparation_gate_review_verdict: pass_for_internal_final_article_preparation_packet_with_limitations
- superseded_final_article_preparation_gate_review_allowed_next_step: prepare_candidate_final_article_preparation_packet_internal_only
- superseded_final_article_preparation_packet_artifact_level: final_article_preparation_packet_prepared_internal_only
- superseded_final_article_preparation_packet_allowed_next_step: prepare_human_operator_decision_for_final_article_candidate_creation_internal_only
- superseded_final_article_preparation_packet_review_note: publish candidate remain not_created
- superseded_final_article_candidate_creation_decision_preparation_artifact_level: human_operator_final_article_candidate_creation_decision_preparation_prepared_internal_only
- superseded_final_article_candidate_creation_decision_preparation_allowed_next_step: await_human_operator_decision_on_final_article_candidate_creation_internal_only
- superseded_final_article_candidate_creation_decision_preparation_note: Decision preparation is complete but no decision is recorded
- superseded_final_article_candidate_creation_decision_artifact_level: human_operator_final_article_candidate_creation_decision_option_a_recorded_internal_only
- superseded_final_article_candidate_creation_decision_allowed_next_step: prepare_internal_final_article_candidate_with_limitations_only
- superseded_final_article_candidate_creation_decision_note: Option A is recorded
- superseded_final_article_candidate_creation_decision_status_note: new_final_article_candidate_status not_created
- superseded_final_article_candidate_option_a_artifact_level: internal_final_article_candidate_option_a_prepared_with_limitations
- superseded_final_article_candidate_option_a_allowed_next_step: review_internal_final_article_candidate_with_limitations_only
- superseded_final_article_candidate_option_a_review_artifact_level: internal_final_article_candidate_option_a_review_completed_with_findings
- superseded_final_article_candidate_option_a_review_allowed_next_step: prepare_human_operator_review_packet_for_internal_final_article_candidate_with_limitations_only
- superseded_final_article_candidate_option_a_history_note: historical Final Article Candidate remains unchanged
- superseded_final_article_candidate_status: final_article_candidate_not_publish_ready
- superseded_source_review_testing_status: real_user_testing_status not_performed
- superseded_source_review_assistive_technology_status: assistive_technology_testing_status not_performed
- superseded_source_review_wcag_status: wcag_conformance_status not_tested

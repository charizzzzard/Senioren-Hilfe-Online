...
- `SHO-INTERNAL-CANDIDATE-001` ist ein interner WhatsApp-Fraud-Checklist Spin-off Candidate nach Brief-003-Option-C-Pivot und Brief-002-Claim-Boundaries; der interne Final Article Candidate wurde mit nicht blockierenden Findings geprueft, bleibt nicht publish-ready und ist kein offizieller fuenfter MVP-Brief.
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| SHO-INTERNAL-CANDIDATE-001 | WhatsApp-Fraud-Checklist | final_article_candidate_review_completed_not_publish_ready | not_assigned | internal_spinoff_candidate_not_official_batch_brief | prepare_source_metadata_freshness_review_internal_only | repo_sources_only_not_live_verified; SHO-SRC-005, SHO-SRC-006 and SHO-SRC-007 bounded; SHO-SRC-004 blocked UI context only | source inventory, brief candidate, brief review, draft candidate, draft review, revision candidate, revision review, gate review, Human Operator decision A, internal Final Article Candidate and Final Article Candidate Review exist; review passed with P2/P3 findings and no P0/P1 | final_article_candidate_not_publish_ready | not_ready | not_accepted | not_ready | not_approved | SHO-CLAIM-007 blocked; source freshness review not performed; no WhatsApp block/report UI instructions; no exact WhatsApp UI paths; no live source verification; no SEO metrics; no official MVP Brief 005 promotion |

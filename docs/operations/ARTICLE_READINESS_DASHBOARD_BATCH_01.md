...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| SHO-INTERNAL-CANDIDATE-001 | WhatsApp-Fraud-Checklist | source_metadata_citation_follow_up_decision_preparation_prepared_internal_only | not_assigned | internal_spinoff_candidate_not_official_batch_brief | await_human_operator_decision_on_source_metadata_and_citation_follow_up_internal_only | candidate-specific mapping unchanged: SHO-SRC-005/006 for SHO-CLAIM-004/005 and SHO-SRC-007 for SHO-CLAIM-006; all use remains limited and not finally approved; final_source_approval_status not_approved; final_claim_approval_status not_approved; final_citation_label_approval_status not_approved; SRC-GAP-WF-006 remains open for publish path; SHO-SRC-004 blocked UI context only | Human Operator Decision Preparation Packet prepared internal-only for source metadata/citation follow-up; human_operator_decision_status not_recorded; selected_option_status pending; no metadata resolved; no citation labels approved; no browsing or live verification in this task; Boundary Review verdict requires_metadata_follow_up_before_publish_path remains; candidate content unchanged; historical Final Article Candidate unchanged; no final article or publish candidate created | historical_final_article_candidate_unchanged_not_publish_ready; new_final_article_candidate_status prepared_internal_only_with_limitations; boundary_review_status completed_internal_only_with_findings; boundary_review_verdict requires_metadata_follow_up_before_publish_path; source_metadata_and_citation_follow_up_packet_status prepared_internal_only; source_metadata_and_citation_follow_up_decision_preparation_status prepared_internal_only; source_metadata_follow_up_status prepared_not_performed; citation_follow_up_status prepared_not_performed; publish_candidate_status not_created | not_ready | not_accepted | not_ready | not_approved | SHO-CLAIM-007 and SHO-SRC-004 blocked; no metadata resolution, final source/claim/citation approval, Publish Candidate, UI validation, exact paths or official MVP Brief 005 promotion |

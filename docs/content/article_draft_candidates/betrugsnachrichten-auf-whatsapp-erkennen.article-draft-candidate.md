...
linked_draft_scaffold: docs/content/article_draft_scaffolds/betrugsnachrichten-auf-whatsapp-erkennen.draft-scaffold.md
...
# Article Draft Candidate: Betrugsnachrichten auf WhatsApp erkennen

## Draft Status

This is a non-final article draft candidate.

It is not publish-ready.

It is not Operator accepted.

It excludes WhatsApp block/report UI instructions because SHO-CLAIM-007 remains blocked.

## Scope

In scope:

- suspicious new-number / alleged-relative message pattern
- verification through known contact channels before reacting
- general phishing/smishing pressure, sender and link warning patterns
- calm senior-first emergency flow
- printable checklist draft candidate
...
## Source/Claim Use Rules

Allowed:

- SHO-CLAIM-004 with SHO-SRC-005 and SHO-SRC-006
- SHO-CLAIM-005 with SHO-SRC-005 and SHO-SRC-006
- SHO-CLAIM-006 with SHO-SRC-007
...
> "Hallo, ich habe eine neue Nummer. Bitte speichere sie."
...
Wenn mehrere Warnzeichen zusammenkommen, sollten Sie besonders vorsichtig sein.

### 4. Sofort-Check: Was tun, bevor Sie antworten?

1. Legen Sie das Smartphone kurz weg.

2. Klicken Sie keinen Link an. [claim: SHO-CLAIM-006 | sources: SHO-SRC-007]

3. Senden Sie kein Geld. [claim: SHO-CLAIM-005 | sources: SHO-SRC-005, SHO-SRC-006]

4. Rufen Sie die bekannte alte Nummer der Person an. [claim: SHO-CLAIM-005 | sources: SHO-SRC-005, SHO-SRC-006]
...
Dieser Abschnitt ist eine Sicherheitsorientierung.

Er ist keine juristische Beratung.

### 5. Typische Warnsignale

- Neue Nummer: Jemand behauptet, eine neue Telefonnummer zu haben. [claim: SHO-CLAIM-004 | sources: SHO-SRC-005, SHO-SRC-006]

- Eile: Sie sollen sofort reagieren. [claim: SHO-CLAIM-006 | sources: SHO-SRC-007]

- Geld: Sie sollen schnell Geld schicken. [claim: SHO-CLAIM-005 | sources: SHO-SRC-005, SHO-SRC-006]

- Codes oder Daten: Sie sollen etwas weitergeben, das privat bleiben sollte. [claim: SHO-CLAIM-006 | sources: SHO-SRC-007]

- Link: Sie sollen auf eine Seite gehen. [claim: SHO-CLAIM-006 | sources: SHO-SRC-007]
...
Draft checklist needs review before publishing.

- Ich klicke keine Links an. [claim: SHO-CLAIM-006 | sources: SHO-SRC-007]
- Ich zahle nicht sofort. [claim: SHO-CLAIM-005 | sources: SHO-SRC-005, SHO-SRC-006]
...
- SHO-CLAIM-007 remains blocked and must not be used for final WhatsApp block/report UI instructions.
...
This draft candidate is not final article text, not publish-ready content and not Operator Acceptance.

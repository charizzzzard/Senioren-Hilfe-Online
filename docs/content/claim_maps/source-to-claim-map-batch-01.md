...
| SHO-CLAIM-007 | SHO-MVP-BRIEF-002 | betrugsnachrichten-auf-whatsapp-erkennen | Blocking or reporting suspicious WhatsApp contacts remains a potential practical step but needs WhatsApp manual review. | SHO-SRC-004 | needs_manual_review | needs_manual_review | needs_manual_review_before_draft | Official WhatsApp source candidate is relevant but not manually verified yet. WHATSAPP_SOURCE_MANUAL_REVIEW_BATCH_01 recorded a manual review attempt, but no line-level evidence sufficient for draft use. Claim remains blocked before draft. | Do not publish final block/report UI instructions yet. |

...
# Research Input: Betrugsnachrichten auf WhatsApp erkennen

## Zweck

Diese Datei sammelt Research-Eingaben für den vorhandenen Brief `SHO-MVP-BRIEF-002`.
...
- Fraud/phishing claims have verified non-WhatsApp evidence, but WhatsApp block/report claim remains blocked.
